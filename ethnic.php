...
<div class="top">
	...
	<a href="logout1.php" style="float:right;text-decoration:none;margin-top:0;">Logout!</a>
    </div>
</div>
...
<div class="content_wrap">
   <div id="sidebar">
			...
			<ul id="cats">
				<li><a href="ethnic.php">Ethnic Wear</li>
	...
	//Create query 
	$qry = "SELECT * FROM PRODUCT WHERE PRODUCT_ID BETWEEN 1010 AND 1030"; //Execute query 
  ...
  echo 
	...
	<td width=60% ><h3>'.$row['PRODUCT_NAME'].'</h3><br/>
	
    Rs. '.$row['PRODUCT_PRICE'].'<br/>
	'.$row['SPECIFICATION'].'</td><td>
	<a href="cart1.php" style="text-decoration:none" class="styl2">ADD TO CART</a></td></tr>';}
	echo '</table></div>';
	?>	
