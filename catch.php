...
<div class="content_wrap">
   <div id="sidebar">
			...
			<ul id="cats">
				<li><a href="mobile.php">Mobile</li>
	...
	//Create query 
	$qry = "SELECT * FROM PRODUCT WHERE PRODUCT_ID BETWEEN 3000 AND 4000"; //Execute query 
  ...
  echo 
	...
	echo '<tr><td width="20%"  valign="top"><img src = "images/'.$row['PRODUCT_IMAGE'].'" height="300" width="150"></a></td>
