...
<div class="content_wrap">
   <div id="sidebar">
			...
			<ul id="cats">
				<li><a href="#">Kids Apparel</li>
				<li><a href="#">School Supplies</li>
				
			</ul>
			<div id="side_title">All</div>
			<ul id="cats">
				<li><a href="#">Boys Apparel</li>
				<li><a href="#">Girls Apparel</li>
				<li><a href="#">Bags</a></li>
				<li><a href="#">Stationery<a></li>
				<li><a href="#">Tiffin/Flasks</a></li>
	...
	//Create query 
	$qry = "SELECT * FROM PRODUCT WHERE PRODUCT_ID BETWEEN 4000 AND 5000"; //Execute query 
	$result = mysqli_query($link, $qry); 
	echo '<h1>The Kids Section is - </h1>'; 
  echo 
	'<table border="1">
