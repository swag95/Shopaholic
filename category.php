...
<div class="content_wrap">
  ...
  echo 
	...
	<form name="cart" method="post" action="cart1.php">
	<table><tr><td>QUANTITY : <input type= "text" name= "quant"></td><tr><td><input type="submit" name="submit" value="ADD TO CART" class="styl2" style="text-decoration:none"></td>
