...
<div class="content_wrap">
   <div id="sidebar">
	...
	//Create query 
	$qry = "SELECT * FROM PRODUCT WHERE PRODUCT_ID IN(1052,1054,1065)"; //Execute query 
  ...
  echo 
	...
	echo '<tr><td align="center"><img src = "images/'.$row['PRODUCT_IMAGE'].'" height="300" width="220"></a></td>
