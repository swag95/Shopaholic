...
if(!($_POST['user'] && $_POST['email'] && $_POST['pass'] && $_POST['street'] && $_POST['pin'] 
&& $_POST['city'] && $_POST['state'] && $_POST['phoneno'])){
...
$link = mysqli_connect('localhost', 'root', '');
 ...
 //Create Insert query 
 $query = "INSERT INTO CUSTOMER(EMAIL_ID,PASSWORD,STREET,CITY,PIN,STATE,USERNAME,PHONENO)VALUES($email,$pass, $street, $city, $pin, $state, $user, $phoneno)"; 
